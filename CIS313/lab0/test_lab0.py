...
class T13_TestingGCD(unittest.TestCase):

    def test_self_test(self):
        g1 = lab0.mathOps(5,25)
        print(g1)
        print(repr(g1))
        self.assertEqual(g1.gcd() ,5)
        self.assertEqual(g1.lcm(), 25)
        print("\n")

class T14_TestingLCM(unittest.TestCase):
    def test_self_test(self):
        g1 = lab0.mathOps(77,99)
        print(g1)
        print(repr(g1))
        self.assertEqual(g1.gcd() , 11)
        self.assertEqual(g1.lcm() , 693)
        print("\n")
