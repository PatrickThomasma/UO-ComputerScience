...
class rb_tree(object):
    ...
    def left_rotate(self, current_node):
        ...
        if current_node is None:
            raise KeyError #checking for empty node
    ...
    def __rb_insert_fixup(self, z):
        ...
        while z.parent.color == 'red':
            ...
            else: #pseudocode is everything from the book
    ...
    def __rb_delete_fixup(self, x):
        ...
        while (x is not self.root) and (x.color is "black"):
            if x is x.parent.left:
                ...
                if w.color is "red":
                    w.color = "black"
                    x.parent.color = "red" #similar to pseudocode from textbook
                ...
                if (w.left.color is "black") and (w.right.color is "black"):
                    ...
                    self.left_rotate(x.parent)
                    x = self.root
            else: #Flipping the functions around left/right case 
                w = x.parent.left
                if w.color is "red":
                    w.color = "black"
                    x.parent.color = "red"
                    ...
                    w = x.parent.left
                if (w.right.color is "black") and (w.right.color is "black"):
                    w.color = "red"
                    x = x.parent
                else:
        ...
        x.color = 'black' #set the root to black
