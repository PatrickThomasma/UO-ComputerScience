...
class Test_Insert(unittest.TestCase):
    ...
    def test_insert_down(self): #New test case
        low_bits = BitField(0,5)
        self.assertEqual (low_bits.insert(0b11011, 0b11101_00000), 0b11101_11011)
...
class Test_Signed_Extraction(unittest.TestCase):
    ...
    def test_extract_neg(self): #New test Case
        bitfield = BitField(9,11)
        field_bits = 0b_101_111_010_110 #Extarcting 101
        self.assertEqual(bitfield.extract_signed(field_bits), -3)
